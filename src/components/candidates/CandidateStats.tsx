...
export function CandidateStats({ statusFilter, searchQuery }: CandidateStatsProps) {
  ...
  return (
    <p className="text-sm text-muted-foreground whitespace-nowrap">
      ...
      {' — '}
      <span className="font-medium text-green-600 dark:text-green-400">{approved}</span> approved
      {' · '}
